...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addPassword(Password password) {
        ...
        values.put(COLUMN_LOGIN, EncryptionHelper.encrypt(password.getLogin()));
        values.put(COLUMN_PASSWORD, EncryptionHelper.encrypt(password.getPassword()));
    ...
    public List<Password> getAllPasswords() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                password.setLogin(EncryptionHelper.decrypt(cursor.getString(2)));
                password.setPassword(EncryptionHelper.decrypt(cursor.getString(3)));
